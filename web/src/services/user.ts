...
export const userService = {
   ...
   * @returns 重置结果
   */
  resetUserFilters: (): Promise<ApiResponse<void>> => {
    return request.post('/api/users/reset-filters');
  },
   ...
   * @returns 删除结果
   */
  batchDeleteUsers: (ids: string[]): Promise<ApiResponse<{ success: number, failed: number }>> => {
